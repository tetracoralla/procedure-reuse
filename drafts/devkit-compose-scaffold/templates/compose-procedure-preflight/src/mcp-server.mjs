 ...
 * Tool __OPERATION__ calls runPreflight. Observation remains file.inspect.
 */
...
export const TOOL_NAME = __OPERATION_JSON__;
export const SERVER_NAME = __PLUGIN_ID_JSON__;
...
export function initializeResult(params) {
  ...
  return {
    ...
    instructions: "Call __OPERATION__ with a workspace grant, a relative delivery root, and exactly one of spec or specPath. Observation is file.inspect; comparison is combinator code, not raster.verify.",
  };
}
