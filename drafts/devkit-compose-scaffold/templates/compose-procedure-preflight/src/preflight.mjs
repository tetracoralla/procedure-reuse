 ...
 *
 * Missing required slots are recorded here so an unfinished scaffold still
 * demonstrates that the spec file drives execution. Present-file comparison
 * is author-owned and starts as CORE_NOT_IMPLEMENTED.
 */
