#!/usr/bin/env node
/**
 * openadam.procedure-jsonl.v0.2 adapter for org.example.unfinished-compose.preflight@0.1.0
 *
 * Calls src/preflight.mjs. Observation remains file.inspect. Not raster.verify.
 */
...
const PROCEDURE_ID = "org.example.unfinished-compose.preflight";
...
function mapThrown(error) {
  ...
  if (error && error.code === "CORE_NOT_IMPLEMENTED") {
