 ...
 * Tool unfinished_compose_preflight calls runPreflight. Observation remains file.inspect.
 */
...
export const TOOL_NAME = "unfinished_compose_preflight";
export const SERVER_NAME = "unfinished-compose-preflight";
...
export const TOOL_DEFINITION = {
  name: TOOL_NAME,
  title: "Unfinished compose preflight",
  description: "Generated scaffold left unfinished on purpose so check fails until compareSlot exists.",
...
export function initializeResult(params) {
  ...
  return {
    ...
    instructions: "Call unfinished_compose_preflight with a workspace grant, a relative delivery root, and exactly one of spec or specPath. Observation is file.inspect; comparison is combinator code, not raster.verify.",
  };
}
