# Unfinished compose preflight product model
...
- CLI: `src/cli.mjs`
- Procedure JSONL v0.2: `procedure/adapter.mjs` implementing `org.example.unfinished-compose.preflight@0.1.0`
- MCP stdio: `src/mcp-server.mjs` tool `unfinished_compose_preflight`
